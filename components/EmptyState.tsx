      ...
      <div className="flex flex-col items-center justify-center h-full text-center px-4 py-12">
        <div className="max-w-2xl">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Compare responses from multiple AI providers side by side. Select providers above and start a conversation!
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">1. Configure API Keys</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Go to Settings and add API keys for the providers you want to compare.
              </p>
            </div>
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">2. Select Providers</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Choose which AI providers to compare for each conversation.
              </p>
            </div>
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Start Comparing</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Send a message and see how different providers respond to the same prompt.
              </p>
            </div>
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Analyze Results</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
